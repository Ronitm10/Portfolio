...
export const HERO_CONTENT = `I am a dynamic and dedicated software engineer working at SS&C Intralinks with a Master’s degree in Information Systems from Northeastern University and over Four years of experience in the industry. I excel in designing, developing, and maintaining robust and scalable backend systems that support complex web applications. My expertise spans various technologies, including JavaScript, Node JS, Express JS, Java, C#, Python, and cloud platforms like AWS. With a proven track record of collaborating effectively with cross-functional teams and delivering high-quality code, I am passionate about driving innovation and optimizing performance to achieve business goals and enhance user experiences.`;

export const ABOUT_TEXT = `As a results-driven Software Developer with a Master’s in Information Systems and over three years of industry experience, I excel in designing, developing, and maintaining robust and scalable backend systems for complex web applications. My expertise spans a variety of programming languages and technologies, including JavaScript, Node JS, Express JS, Java, C#, and Python.

My collaborative approach and effective communication skills enable me to work seamlessly with cross-functional teams, ensuring high-quality code delivery. Additionally, I am proficient in cloud technologies such as AWS, and I have a strong background in database management, including MySQL, PostgreSQL, and MongoDB.
...
export const EXPERIENCES = [
  {
    ...
    description: `• Architected a high-performance Node.js microservice with Express.js to calculate Apache Kafka consumer lag within the system, utilizing custom metrics to dynamically manage the scaling of Kubernetes pods and improve service uptime
    ...
    technologies: ["Node JS", "Express JS", "REST API", "Kafka", "Kubernetes", "AWS", "ElasticSearch", "Security"],
  },
  {
    year: "June 2019 - June 2021",
    role: "Software Developer",
    company: "Tripstack",
    description: `• Developed a Node.js microservices setup, cutting booking and search times by 35%, and utilized AWS tools to enhance fare accuracy, driving a 40% efficiency boost and substantial savings
  ...
  },
  {
    ...
    technologies: ["SQL", "Unit Test", "SDLC", "TDD"],
  },
];
...
export const CONTACT = {
  ...
  email: "ronitchougule7@gmail.com",
};
